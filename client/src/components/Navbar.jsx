      ...
      <nav>
        {auth ? (
          <>
            ...
            <Link to={"/category/hate"}>Hate</Link>
            <Link to={"/category/politics"}>Politics</Link>
            <Link to={"/category/other"}>Others</Link>
      ...
      <div id="basic-menu" style={{ display: menuOpen ? "block" : "none" }}>
        {auth ? (
          <>
            ...
            <Link to={"/category/love"} onClick={closeMenu}>
              Love
            </Link>
            <Link to={"/category/hate"} onClick={closeMenu}>
              Hate
            </Link>
            <Link to={"/category/politics"} onClick={closeMenu}>
              Politics
            </Link>
            <Link to={"/category/other"} onClick={closeMenu}>
              Others
            </Link>
            <h4
              className="nav-link"
